...
import com.example.hoangtienmanh.imagelistview.Video;
import com.example.hoangtienmanh.imagelistview.VideoYoutubeAdapter;
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.action_three:
                        Intent intent2 = new Intent(VideoActivity.this, PersonalActivity.class);
